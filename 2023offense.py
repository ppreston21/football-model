...
url = "https://www.pro-football-reference.com/years/2023/#team_stats"
...
df.to_csv("nfl_2023__offense_stats.csv", index=False)

print("Data has been successfully scraped and saved as 'nfl_2023__offense_stats.csv'.")
